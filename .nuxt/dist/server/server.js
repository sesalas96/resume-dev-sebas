  ...
  "messages": {
    ...
    "es": {
      ...
      "educationDegrees": {
        "title": "Educación",
        "degrees": [{
          "collage": "Intituto Tecnológico de Costa Rica",
          "name": "Ingeniero en Informática",
          "itemList": ["Ciencias de la Computación"],
      ...
      "workExperiences": {
        ...
        "works": [{
          ...
          "responsabilities": ["Responsable de diseñar, codificar y mantener grupos de aplicaciones usadas en el mundo del retail por empresas multinacionales como Pepsico, Unilever, Quilmes, etc.", "Lider del equipo web, estoy a cargo de la toma de decisiones técnicas y acerca de como el equipo va a trabajar en los diferentes proyectos.", "Desarrollador Backend: .NET Core | .NET Framework | NodeJs | MSSQL | PostgreSQL | MongoDB.", "Desarrollador Frontend: VueJs | ReactJs | Javascript | JQuery.", "Aplicaciones de Escritorio: .NET Windows Form Applications."],
          "startEndDate": "Noviembre 2017 - Presente"
        }, {
          "position": "Point of Sales (Responsive Web App)",
          "companie": "Desarrollador Front-End - ReactJS",
          "responsabilities": ["Responsable del diseño y mantenimiento del ecommerce.", "Diseño Gráfico (Adobe Photoshop and Adobe Illustrator).", "Soporte Técnico.", "Mejora de los procesos de negocio."],
      ...
      "skills": {
        "title": "Habilidades",
        "iconsTitle": "Lenguajes de Programación & Herramientas",
        ...
        "workflow": "Workflow",
        "itemList": ["Diseño Responsive & UX", "Cross Browser Testing & Debugging", "Contrucción de REST API", "Desarrollo Ágil & Scrum", "Trabajo en equipo", "Patrones de diseño"]
      },
      "interests": {
        "title": "Hobbies",
        "firstBlock": "Además de ser desarrollador web, disfruto la gran parte de mi tiempo escuchando y tocando música. Me encanta cantar y tocar el piano en mis ratos libres!. 🎹🎵",
        "secondBlock": "También le dedico una gran parte de mi tiempo libre a explorar las última tecnologias y avances en el mundo del backend/frontend, y programo en mis proyectos personales! 🙌👨‍💻"
      }
    }
  }
};
